...
const SECTORS = {
  ...
  sport: {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Abonnement VIP — couple (madame ou monsieur)", "1 mois", "15 000 F CFA"],
        ],
      },
    ],
    cible: "Tout le monde.",
    ...
    heroPhotos: [
      "images/salle-de-sport/photos/salle-de-sport-15.jpg",
      "images/salle-de-sport/photos/salle-de-sport-24.jpg",
      "images/salle-de-sport/photos/salle-de-sport-16.jpg",
    ],
    videos: [],
  ...
  garderie: {
    ...
    heroPhotos: [
      "images/garderie/photos/garderie-4.jpg",
      "images/garderie/photos/garderie-6.jpg",
      "images/garderie/photos/garderie-11.jpg",
    ],
  ...
  batiment: {
    ...
    tagline: "BTP",
    letter: "E",
    manager: { name: "Tossa Anani", title: "Responsable", photo: "images/equipe/respo-btp.png" },
  ...
  cosmetique: {
    ...
    heroPhotos: [
      "images/maxi-cosmetique/photos/maxi-cosmetique-2.jpg",
      "images/maxi-cosmetique/photos/maxi-cosmetique-8.jpg",
      "images/maxi-cosmetique/photos/maxi-cosmetique-6.jpg",
    ],
    videos: [],
